    ...
    switch (action) {
      ...
      case "tts":
        if (speechSynthesis.speaking) {
          ...
          // Pega o container pelo seletor de classe
          const container = document.querySelector("main.container");
        if (container) {
          const texto = container.innerText; // só o texto dentro do main
          const msg = new SpeechSynthesisUtterance("Iniciando leitura. " + texto);
          msg.lang = "pt-BR";
          msg.rate = 1;
          msg.pitch = 1;
